...
WORKDIR /go/src/github.com/contentstudio/contentstudio-images-api-master
...
COPY --from=builder /go/src/github.com/contentstudio/contentstudio-images-api-master/main .
